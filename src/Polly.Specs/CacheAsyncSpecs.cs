...
using Polly.Caching;
using Polly.Caching.SqlDependency.Specs.Helpers;
...
namespace Polly.Specs.Caching
{
    ...
    public class CacheAsyncSpecs : IDisposable
    {
        ...
        {
            IAsyncCacheProvider cacheProvider = new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions());
        ...
        public async Task Should_return_value_from_cache_and_not_execute_delegate_if_cache_holds_value()
        {
            ...
            IAsyncCacheProvider SqlDependencyCacheProvider = new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions());
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, TimeSpan.MaxValue);
            await SqlDependencyCacheProvider.PutAsync(operationKey, valueToReturnFromCache, new Ttl(TimeSpan.MaxValue), CancellationToken.None, false).ConfigureAwait(false);
        ...
        public async Task Should_execute_delegate_and_put_value_in_cache_if_cache_does_not_hold_value()
        {
            ...
            (bool cacheHit1, object fromCache1) = await SqlDependencyCacheProvider.TryGetAsync(operationKey, CancellationToken.None, false).ConfigureAwait(false);
            ...
            (bool cacheHit2, object fromCache2) = await SqlDependencyCacheProvider.TryGetAsync(operationKey, CancellationToken.None, false).ConfigureAwait(false);
        ...
        public async Task Should_execute_delegate_and_put_value_in_cache_but_when_it_expires_execute_delegate_again()
        {
            ...
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, ttl);
        ...
        public async Task Should_execute_delegate_but_not_put_value_in_cache_if_cache_does_not_hold_value_but_ttl_indicates_not_worth_caching()
        {
            ...
            IAsyncCacheProvider SqlDependencyCacheProvider = new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions());
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, TimeSpan.Zero);
        ...
        public async Task Should_return_value_from_cache_and_not_execute_delegate_if_prior_execution_has_cached()
        {
            ...
            var cache = Policy.CacheAsync(new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions()), TimeSpan.MaxValue);
        ...
        {
            IAsyncCacheProvider SqlDependencyCacheProvider = new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions());
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, TimeSpan.MaxValue, context => context.OperationKey + context["id"]);

            object person1 = new object();
            await SqlDependencyCacheProvider.PutAsync("person1", person1, new Ttl(TimeSpan.MaxValue), CancellationToken.None, false).ConfigureAwait(false);
            object person2 = new object();
            await SqlDependencyCacheProvider.PutAsync("person2", person2, new Ttl(TimeSpan.MaxValue), CancellationToken.None, false).ConfigureAwait(false);
        ...
        public async Task Should_allow_custom_ICacheKeyStrategy()
        {
            ...
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, new RelativeTtl(TimeSpan.MaxValue), cacheKeyStrategy, emptyDelegate, emptyDelegate, emptyDelegate, noErrorHandling, noErrorHandling);
        ...
        public async Task Should_honour_cancellation_during_delegate_execution_and_not_put_to_cache()
        {
            ...
            (bool cacheHit, object fromCache) = await SqlDependencyCacheProvider.TryGetAsync(operationKey, CancellationToken.None, false).ConfigureAwait(false);
        ...
        public async Task Should_call_onError_delegate_if_cache_get_errors()
        {
            ...
            IAsyncCacheProvider SqlDependencyCacheProvider = new StubErroringCacheProvider(getException: ex, putException: null);
            ...
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, TimeSpan.MaxValue, onError);
        ...
        {
            Exception ex = new Exception();
            IAsyncCacheProvider SqlDependencyCacheProvider = new StubErroringCacheProvider(getException: null, putException: ex);
        ...
        public async Task Should_execute_oncacheget_after_got_from_cache()
        {
            ...
            IAsyncCacheProvider SqlDependencyCacheProvider = new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions());
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, new RelativeTtl(TimeSpan.MaxValue), DefaultCacheKeyStrategy.Instance, onCacheAction, emptyDelegate, emptyDelegate, noErrorHandling, noErrorHandling);
            await SqlDependencyCacheProvider.PutAsync(operationKey, valueToReturnFromCache, new Ttl(TimeSpan.MaxValue), CancellationToken.None, false).ConfigureAwait(false);
        ...
        public async Task Should_execute_oncachemiss_and_oncacheput_if_cache_does_not_hold_value_and_put()
        {
            ...
            IAsyncCacheProvider SqlDependencyCacheProvider = new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions());
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, new RelativeTtl(TimeSpan.MaxValue), DefaultCacheKeyStrategy.Instance, emptyDelegate, onCacheMiss, onCachePut, noErrorHandling, noErrorHandling);
        ...
        public async Task Should_execute_oncachemiss_but_not_oncacheput_if_cache_does_not_hold_value_and_returned_value_not_worth_caching()
        {
            ...
            IAsyncCacheProvider SqlDependencyCacheProvider = new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions());
            var cache = Policy.CacheAsync(SqlDependencyCacheProvider, new RelativeTtl(TimeSpan.Zero), DefaultCacheKeyStrategy.Instance, emptyDelegate, onCacheMiss, onCachePut, noErrorHandling, noErrorHandling);
        ...
        public async Task Should_not_execute_oncachemiss_if_dont_query_cache_because_cache_key_not_set()
        {
            ...
            var cache = Policy.CacheAsync(new SqlDependencyCacheProvider(OptionsHelper.GetDefaultOptions()), new RelativeTtl(TimeSpan.MaxValue), DefaultCacheKeyStrategy.Instance, emptyDelegate, onCacheMiss, emptyDelegate, noErrorHandling, noErrorHandling);
